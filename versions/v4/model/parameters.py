...
def get_args():
    ...
    # v4 dynamic reliability-aware fusion. These defaults keep existing commands compatible.
    parser.add_argument('--dynamic_fusion', action='store_true', help='Enable v4 dynamic context fusion in dedicated v4 scripts.')
    ...
    parser.add_argument('--fuser_hidden_dim', type=int, default=32)
    parser.add_argument('--fuser_dropout', type=float, default=0.1)
    parser.add_argument('--fuser_lr', type=float, default=1e-3)
    parser.add_argument('--fuser_weight_decay', type=float, default=1e-4)
    parser.add_argument('--fuser_patience', type=int, default=5)
    parser.add_argument('--fusion_cache_path', type=str, default=None)
